...
struct FIELD_STRINGS {
  const char FIELD_STRINGS_NULL[sizeof("")];
...
const struct FIELD_STRINGS FIELD_STRINGS = {
  "",
  "code",
  "remote-channel",
  "global-id",
...
const char * const FIELD_STRINGPOOL = (const char * const) &FIELD_STRINGS;

/* This is an array of offsets into FIELD_STRINGPOOL */
const uint16_t FIELD_NAME[] = {
  offsetof(struct FIELD_STRINGS, FIELD_STRINGS_NULL),
...
const unsigned char FIELD_MIN = 16;
const unsigned char FIELD_MAX = 120;
